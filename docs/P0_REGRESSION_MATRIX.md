...
- [x] Android instrumentation launches the real `AndroidLauncher` successfully on an x86_64 emulator and keeps the Activity alive with attached libGDX content (#26).
