...
public final class GameScreen extends ScreenAdapter {
    ...
    private void update(float dt) {
        ...
        if (bossRevealTimer > 0f && bossRevealTarget != null && bossRevealTarget.alive) {
            ...
            float revealX = MathUtils.lerp(player.position.x, bossRevealTarget.position.x,
                BossRevealCameraProfile.BOSS_FOCUS_X);
            float revealY = MathUtils.lerp(player.position.y, bossRevealTarget.position.y,
                BossRevealCameraProfile.BOSS_FOCUS_Y);
